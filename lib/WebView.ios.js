...
var WebView = /** @class */ (function (_super) {
    ...
    function WebView() {
         ...
         */
        _this.callJavaScriptBridgeHandler = function (handlerName, data) {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), _this.getCommands().callJavaScriptBridgeHandler, [handlerName, data]);
        };
        /**
    ...
    WebView.prototype.render = function () {
        ...
        var NativeWebView = nativeConfig.component
            || RNCWebView;
        var webView = (<NativeWebView key="webViewKey" {...otherProps} decelerationRate={decelerationRate} messagingEnabled={typeof onMessage === 'function'} onLoadingError={this.onLoadingError} onLoadingFinish={this.onLoadingFinish} onLoadingProgress={this.onLoadingProgress} onLoadingStart={this.onLoadingStart} onHttpError={this.onHttpError} onMessage={this.onMessage} onScroll={this.props.onScroll} onShouldStartLoadWithRequest={onShouldStartLoadWithRequest} onContentProcessDidTerminate={this.onContentProcessDidTerminate} injectedJavaScript={this.props.injectedJavaScript} injectedJavaScriptBeforeContentLoaded={this.props.injectedJavaScriptBeforeContentLoaded} injectedJavaScriptForMainFrameOnly={injectedJavaScriptForMainFrameOnly} injectedJavaScriptBeforeContentLoadedForMainFrameOnly={injectedJavaScriptBeforeContentLoadedForMainFrameOnly} ref={this.webViewRef} 
