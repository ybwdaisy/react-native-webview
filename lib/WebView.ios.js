...
var WebView = /** @class */ (function (_super) {
    ...
    function WebView() {
         ...
         */
        _this.callJavaScriptBridgeHandler = function (handlerName) {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), _this.getCommands().callJavaScriptBridgeHandler, [handlerName]);
        };
        /**
