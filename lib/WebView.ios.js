...
var WebView = /** @class */ (function (_super) {
    ...
    function WebView() {
         ...
         */
        _this.callJavaScriptBridgeHandler = function (handleName) {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), _this.getCommands().callJavaScriptBridgeHandler, [handleName]);
        };
        /**
